  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_function_defs = 37,                    // function_defs
        S_function_def = 38,                     // function_def
        S_func_start = 39,                       // func_start
        S_statements = 40,                       // statements
        S_statement = 41,                        // statement
        S_decl_vector_stmt = 42,                 // decl_vector_stmt
        S_sizeof_stmt = 43,                      // sizeof_stmt
        S_while_stmt = 44,                       // while_stmt
        S_if_stmt = 45,                          // if_stmt
        S_set_stmt = 46,                         // set_stmt
        S_decl_stmt = 47,                        // decl_stmt
        S_expr = 48                              // expr
      };
    };
        ...
        switch (this->kind ())
    {
      case symbol_kind::S_TYPE: // TYPE
        value.move< CurType > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, CurType&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const CurType& v)
        : Base (t)
        , value (v)
      {}
#endif
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, Value&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const Value& v)
        : Base (t)
        , value (v)
      {}
#endif
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, nodeList&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const nodeList& v)
        : Base (t)
        , value (v)
      {}
#endif
...
switch (yykind)
    {
      case symbol_kind::S_TYPE: // TYPE
        value.template destroy< CurType > ();
        break;
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
      ...
      {}
#if 201103L <= YY_CPLUSPLUS
      symbol_type (int tok, CurType v)
        : super_type (token_kind_type (tok), std::move (v))
#else
      symbol_type (int tok, const CurType& v)
        : super_type (token_kind_type (tok), v)
#endif
      {}
#if 201103L <= YY_CPLUSPLUS
      symbol_type (int tok, Value v)
        : super_type (token_kind_type (tok), std::move (v))
#else
      symbol_type (int tok, const Value& v)
        : super_type (token_kind_type (tok), v)
#endif
      {}
#if 201103L <= YY_CPLUSPLUS
    ...
    // Implementation of make_symbol for each token kind.
      ...
      make_VECTOR ()
      {
        return symbol_type (token::VECTOR);
      }
#else
      static
      symbol_type
      ...
      make_SMALLER ()
      {
        return symbol_type (token::SMALLER);
      }
#else
      static
      symbol_type
      ...
      make_LARGER ()
      {
        return symbol_type (token::LARGER);
      }
#else
      static
      symbol_type
    ...
    , value ()
  {
    ...
    {
      case symbol_kind::S_TYPE: // TYPE
        value.copy< CurType > (YY_MOVE (that.value));
        break;
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    {
      case symbol_kind::S_TYPE: // TYPE
        value.move< CurType > (YY_MOVE (s.value));
        break;
